...
<div class="container">
  <div class="row">
    <div class="col-lg-12" align="center">
      <h1><span class="fa fa-users"></span> Ubah Data Anggota</h1>
    </div>
  </div>
  <div class="row">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-3" align="left">
              ...
              <input type="text" name="nba" value="<?php echo $nba; ?>" class="form-control" required>
            </div>
          ...
          <div class="row" style="margin-top: 5px;">
            ...
            <div class="col-md-3" align="left">
              ...
              <div class="input-group mb-3">
                <input type="text" name="tgl_lahir" class="form-control" id="tgl_lahir" value="<?php echo $data['tgl_lahir']; ?>" required>
          ...
          <div class="row" style="margin-top: 35px;">
            ...
            <div class="col-md-6" style="margin-top: 5px;">
              <a href="data_anggota_ubah.php?nba=<?php echo $nba; ?>" class="btn btn-outline-danger btn-block"><span class="fa fa-refresh"></span>
                Bersih
              </a>
            </div>
          </div>
...
$query = "UPDATE tbl_anggota SET nba='".$nba."', nm_lengkap='".$nm_lengkap."', jk='".$jk."', tgl_lahir='".$tgl_lahir."', pekerjaan='".$pekerjaan."' WHERE nba='".$kd_awal."'";
$sql = mysqli_query($connect, $query);
  if($sql){
    echo "<script language=\"javascript\">alert(\"Berhasil Mengubah Data\");document.location.href='data_anggota.php';</script>";
  }else{
    echo "<script language=\"javascript\">alert(\"Gagal Mengubah Data\");document.location.href='data_anggota.php';</script>";
  }
}
?>