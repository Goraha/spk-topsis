      ...
      <table class="table table-hover table-bordered"
        ...
        <tr>
          ...
          <td class="text-center align-middle"><?php echo $data2['nm_lengkap']; ?></td>
            ...
            ?>
                ...
                <select id="inputState" class="form-control" name="jk" required>
                    ...
                    <?php
                        include "../include/data_kon.php";
                        $sql3 = $pdo->prepare("SELECT * FROM tbl_subkriteria WHERE kd_kriteria='$kd_krit'");
                        $sql3->execute();
                        while($data3 = $sql3->fetch()){
                    ?>
                         <option value="<?php echo $data3['kd_subkriteria']; ?>"><?php echo $data3['nm_subkriteria']; ?></option>
                    <?php
                        }
                    ?>
                </select>
          ...
          <td class="text-center align-middle" style="padding:0px;">
            <a class="btn btn-success" href='data_nilai_alternatif_ubah.php?kd_alternatif=<?php echo $data['kd_alternatif']; ?>' style="margin:0px;"><i class="fa fa-edit"></i> Ubah </a>
          </td>
        </tr>
        <?php
            $no++;
