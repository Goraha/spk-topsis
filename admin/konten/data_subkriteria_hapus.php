...
<div class="container">
  ...
  <div class="row">
    ...
    <h1><span class="fa fa-users"></span> Hapus Data Subkriteria <?php echo $kd_kriteria; ?>/<?php echo $data['nm_kriteria']; ?></h1>
    </div>
  </div>
        ...
        <form method="post" action="" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <div class="row" style="margin-top: 35px;">
              ...
              <div class="col-md-6" style="margin-top: 5px;">
                <a href="data_subkriteria.php" class="btn btn-outline-success btn-block"><span class="fa fa-arrow-left"></span>
                  Batal
                </a>
              </div>
            </div>
...
$query = "DELETE FROM tbl_subkriteria WHERE kd_subkriteria='".$kd_subkriteria."'";
$sql = mysqli_query($connect, $query);
  if($sql){
    echo "<script language=\"javascript\">alert(\"Berhasil Menghapus Data\");document.location.href='data_subkriteria.php';</script>";
  }else{
    echo "<script language=\"javascript\">alert(\"Gagal Menghapus Data\");document.location.href='data_subkriteria.php';</script>";
  }
}
?>