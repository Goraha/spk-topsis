...
<div class="container">
  ...
  <div class="row">
    ...
    <h1><span class="fa fa-users"></span> Hapus Data Kriteria</h1>
    </div>
  </div>
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-3" align="left">
                ...
                <input type="text" name="kd_kriteria" value="<?php echo $kd_kriteria; ?>" class="form-control" disabled>
                <input type="text" name="kd_awal" value="<?php echo $kd_kriteria; ?>" hidden>
              </div>
              <div class="col-md-9" align="left">
                <label>Nama Kriteria</label>
                <input type="text" name="nm_kriteria" class="form-control" value="<?php echo $data['nm_kriteria']; ?>" disabled>
              </div>
            </div>
            <div class="row" style="margin-top: 5px;">
              <div class="col-md-3" align="left">
                <label>Atribut</label>
                <select id="inputState" class="form-control" name="atribut" disabled>
              ...
              <div class="col-md-3" align="left">
                <label>Bobot</label>
                <input type="number" name="bobot" class="form-control" value="<?php echo $data['bobot']; ?>" disabled>
              </div>
            </div>
            ...
            <div class="row" style="margin-top: 35px;">
              ...
              <div class="col-md-6" style="margin-top: 5px;">
                <a href="data_kriteria.php?" class="btn btn-outline-success btn-block"><span class="fa fa-arrow-left"></span>
                  Kembali
                </a>
              </div>
            </div>
...
$query = "DELETE FROM tbl_kriteria WHERE kd_kriteria='".$kd_awal."'";
$sql = mysqli_query($connect, $query);
  if($sql){
    echo "<script language=\"javascript\">alert(\"Berhasil Menghapus Data\");document.location.href='data_kriteria.php';</script>";
  }else{
    echo "<script language=\"javascript\">alert(\"Gagal Menghapus Data\");document.location.href='data_kriteria.php';</script>";
  }
}
?>